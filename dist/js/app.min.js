...
function _init() {
	...
	c>=d?($(".content-wrapper,.right-side").css("min-height",$(window).height()-50),e=d ):($(".content-wrapper,.right-side").css("min-height",d),e=d);
...
),b.hasBindedResize=!0}else a.css( {
...
,screenSizes: {
	...
	selector:a.BSTooltipSelector,container:"body"
}
