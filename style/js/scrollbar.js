// JavaScript Document
	window.onload = function(i){
			...
			var doc = document;  
            var _wheelData = -1;  
            var mainBox = doc.getElementsByClassName('mainBox')[i];  
            ...
            addScroll.prototype = {  
                init : function(mainBox, contentBox, className, i) {  
                    var mainBox = doc.getElementsByClassName(mainBox)[i];  
                    var contentBox = doc.getElementsByClassName(contentBox)[i];  
                ...
                _createScroll : function(mainBox, className) {  
					...
					_scrollBox.className = "scrollBar";
                    return _scroll;  
                },  
                //调整滚动条  
			...
			new addScroll('mainBox', 'innerBox', 'scrollDiv',0);			
